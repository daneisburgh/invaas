...
@login_required
def order_buy_limit(
    symbol, quantity, limitPrice, account_number=None, timeInForce="gtc", extendedHours=False, jsonify=True
):
...
def order_buy_trailing_stop(
    ...
    return order_trailing_stop(
        symbol, quantity, "buy", trailAmount, trailType, None, timeInForce, extendedHours, jsonify
    )
...
def order_sell_fractional_by_quantity(
    ...
    """
    return order(
        symbol, quantity, "sell", None, None, account_number, timeInForce, extendedHours, jsonify, market_hours
    )
...
def order_sell_trailing_stop(
    ...
    """
    return order_trailing_stop(
        symbol, quantity, "sell", trailAmount, trailType, None, timeInForce, extendedHours, jsonify
    )
...
def order_option_spread(
    direction, price, symbol, quantity, spread, account_number=None, timeInForce="gtc", jsonify=True
):
